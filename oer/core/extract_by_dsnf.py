...
class ExtractByDSNF:
    ...
    def __init__(self, origin_sentence='', sentence=None, entity1=None, entity2=None, file_path=None, verbose=False):
    ...
    def build_triple(self, entity1, entity2, relation):
        ...
        if self.verbose:
            print(f'<Triple: {entity1_str} -[{relation_str}]-> {entity2_str}>')
        return triple
